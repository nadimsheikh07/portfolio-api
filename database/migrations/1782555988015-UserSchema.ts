...
export class UserSchema1782555988015 implements MigrationInterface {
    name = 'UserSchema1782555988015'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_usertype_enum" AS ENUM('admin', 'customer')`);
